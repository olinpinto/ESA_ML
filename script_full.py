...
# Training and evaluating, fetching column names
print('Training strated!')
column_names = X_train.columns
train_losses, test_losses, train_accuracies, test_accuracies, predicted_probabilities, df_test_results = mld.train_and_evaluate(net, criterion, optimizer, train_loader, test_loader, num_epochs, column_names)

# Saving the trained model
mld.save_model(net, model_filepath)
print('Training and fitting completed, model save successful!')
...
pt.plot_training_testing_performance(train_losses, test_losses, train_accuracies, test_accuracies, num_epochs, 'tt_performance')
